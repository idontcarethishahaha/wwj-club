...
const navItems = [
  ...
  { label: '方向列表', icon: 'Rank' },
]

// 数据头
const headItems = [
  { type: 'ipt', span: 5, placeholder: '搜索方向名', callback: pageByTitle }
]
...
<template>
  ...
  <my-table module="direction"
            insert-page="/DirectionInsert"
            update-page="/DirectionUpdate"
            :page-info="pageInfo"
